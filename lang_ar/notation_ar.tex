\Extrachap{\LR{(Notation)}مجموع الرموز}
\label{sec: \LR{(Notation) مجموع الرموز}

\section*{\LR{(Introduction)} تمهيد}


من الصعوبة التّوصل إلي مجموعة وحيدة و ثابتة من الرموز لتغطية المجال الشاسع من البيانات و النماذج و الخوارزميات التي نناقشها في هذا الكتيّب. علاوة على ذلك،  العلامات الرياضية المتفق عليها تختلف بين علم تعلّم الآلة و علم الإحصاءات،  و بين الكتب والأوراق العلميّة المختلفة. مع ذلك، فقد حاولنا أن تكون الرموز المستعملة  متّسقة قدر الإمكان. فيما يلي نلخّص معظم الرموز المستخدمة, هذا لا ينفي أن بعض المقاطع الفرديّة في الكتيّب قد تعرض رموزا جديدة. إعلم أيضا أن بعض الرموز قد يكون لها معان مختلفة تبعا للسياق, رغم أننا سنحرص على تجنّب ذلك قدر الإمكان.
