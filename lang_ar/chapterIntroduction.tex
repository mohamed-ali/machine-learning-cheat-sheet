\chapter{تمهيد \hfill \LR{Introduction}}
\section{أنواع تعلّم الآلة \hfill \LR{Types of machine learning}}

\begin{english}
\begin{equation}\nonumber
\begin{cases}
\text{Supervised learning \RL{التعلم الخاضع للإشراف}} \begin{cases} \text{Classification} \\ \text{Regression} \end{cases}\\
...
\section{المكونات الثلاثة لنماذج تعلّم الآلة}

النوذج\LR{(Model)} = التمثيل\LR{(Representation)} + التقييم \LR{(Evaluation)}+ التحسين\LR{(Optimization)} 
\LR{\footnote{Model = Representation + Evaluation + Optimization. Domingos, P. A few useful things to know about machine learning. Commun. ACM. 55(10):78–87 (2012).}}

في ما يلي سيقع تفسير كل مكون من هذه المكونات الثلاثة على حدا. 

\subsection{التمثيل \hfill \LR{Representation}}
...
\subsection{التقييم \hfill \LR{Evaluation}}
\begin{english}
...
\subsection{التقييم \hfill \LR{Optimization}}
\begin{english}
